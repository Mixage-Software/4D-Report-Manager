...
If (False:C215)
	C_LONGINT:C283(_QR_SetTextProperty ;$1)
	C_LONGINT:C283(_QR_SetTextProperty ;$2)
	C_TEXT:C284(_QR_SetTextProperty ;$3)
	C_LONGINT:C283(_QR_SetTextProperty ;$4)
	C_LONGINT:C283(_QR_SetTextProperty ;$5)
End if 
...
Case of 
		  ...
		  //: (Not(QR_is_valid_area($Lon_area)))
		
		  //NOTHING MORE TO DO
		
		  //______________________________________________________
	: ($Lon_column=0) & ($Lon_row=0)  //applies to all cells
